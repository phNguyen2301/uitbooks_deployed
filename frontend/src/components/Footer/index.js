    ...
    <footer>
        ...
        <div className='footer-links'>
          ...
          <div className='footer-icons-wrapper'>
            <div className='footer-icons-items'>
              ...
              />
              <img
                src='/images/footer/UITBooks.com.png'
                alt='UIT'
                className='uitbooks'
              />
              <div className='footer-info'>
                Chúng tôi đảm bảo giao hàng trong vòng 24h, cam kết đổi trả hàng
                nếu có sai sót. <br />
                <Link to='/'>UITBooks.com</Link> nhận đặt hàng trực tuyến và
                giao hàng tận nơi. KHÔNG hỗ trợ đặt mua và nhận hàng trực tiếp
                tại văn phòng cũng như tất cả hệ thống UITBooks trên toàn quốc.
              </div>
              <div className='social-icons'>
                ...
                >
                  <img
                    src='https://drive.google.com/uc?id=1hKFmUYEn44aNhc7AUivTnqAJ-cLCiXIg'
                    alt='facebook'
                  />
                </a>
                <a
                ...
                >
                  <img
                    src='https://drive.google.com/uc?id=1EyW6CxiAiKq1QeWk1hPgkYyuwx_4FaSl'
                    alt='instagram'
                  />
                </a>
                <a
                ...
                >
                  <img
                    src='https://drive.google.com/uc?id=1g3ktW0qJ0H3Ym-tAzDHFElKoVo3lQmia'
                    alt='youtube'
                  />
                </a>
                <a
                ...
                >
                  <img
                    src='https://drive.google.com/uc?id=1Gol-wJK29brj_e6TdWs9X5Tda-am1iac'
                    alt='twitter'
                  />
                </a>
              </div>
              <div className='download'>
                <a href='/' title='IOS'>
                  <img src='/images/footer/get-on-appstores.png' alt='ios' />
                </a>
                <a href='/' title='Google'>
                  <img src='/images/footer/get-on-chplay.png' alt='chplay' />
                </a>
              </div>
            </div>
          </div>
      ...
      <section className='social-media'>
        <small className='website-rights'>
          © Bản quyền thuộc về UITBooks - 2022
        </small>
      </section>
    </footer>
  );
